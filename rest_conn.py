...
def main():
    ...
    slim_data, limit    = paginate(now=now, max_per_page=max_per_page, limit=6000, url = "https://api.opensea.io/api/v1/assets?asset_contract_address=0x79986af15539de2db9a5086382daeda917a9cf0c", write_raw=True)
